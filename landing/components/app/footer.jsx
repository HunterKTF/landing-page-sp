    ...
    return (
        <div className="hidden w-full h-full bg-white drop-shadow-2xl xl:flex flex-col gap-3 justify-center rounded-t-3xl px-[40px]">
            <div className="grid grid-cols-3 gap-4">
                ...
                <div className="">
                    <p>
                        ¡Síguenos en nuestras redes sociales para descubrir contenido exclusivo
                        sobre el mundo de la ingeniería Biomédica!
                    </p>
                </div>
            ...
            <div className="flex w-full justify-center">
                <p className="text-md text-slate-700/80 font-sans">Copyright © 2024 Softpital</p>
            </div>
        </div>
    )
}